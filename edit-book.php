		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" 
		      ...
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li class="nav-item">
		          <a class="nav-link" 
		             href="add-category.php">هاوپۆل زیاد بکە</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" 
		             href="add-author.php">نوسەر زیاد بکە</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" 
     ...
     <form action="php/edit-book.php"
		...
		<div class="mb-3">
		    ...
		    <a href="uploads/cover/<?=$book['cover']?>"
		       class="link-dark">کەڤەری ئێستا</a>
		</div>
